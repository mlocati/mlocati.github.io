---
title:  "gettext 0.25 and iconv 1.17 - Binaries for Windows"
...
{% assign gettext_version = "0.25" %}
{% assign iconv_version = "1.17" %}
{% assign release_prefix = "https://github.com/mlocati/gettext-iconv-windows/releases/download/v0.25-v1.17" %}
